...
number=0
stringDate="02-10-2018"
dateObject=datetime.datetime.strptime(stringDate,"%m-%d-%Y")
stopDate=datetime.datetime.today()-datetime.timedelta(days=0)

f=open("NBADiamondMine.csv","a")
...
while(dateObject<=stopDate): 
      ...
      for game in listofGames:
          ...
          if away1Q!="":
              ...
              print(str(number)+","+date+","+awayTeam+","+away1Q+","+away2Q+","+away3Q+","+away4Q+","+awayTotal+","+homeTeam+","+home1Q+","+home2Q+","+home3Q+","+home4Q+","+homeTotal+","+str(gameTotal)+","+overUnder+","+result+","+favorite+","+str(spread)+","+homePtsGame+","+homeOppPts+","+homeSRS+","+homePace+","+homeoffRating+","+homedefRating+","+awayPtsGame+","+awayOppPts+","+awaySRS+","+awayPace+","+awayoffRating+","+awaydefRating+"\n")
          else:
                hold=0
